...
export class LanguageReadersComponent {
  ...
  translateToLeft() {
    ...
    console.log('Selected Cover ID: ', this.selectedCoverId);
    console.log('Slider Counter Left: ', this.slidesCounterLeft);
    console.log('Slider Counter Right: ', this.slidesCounterRight);
  }
